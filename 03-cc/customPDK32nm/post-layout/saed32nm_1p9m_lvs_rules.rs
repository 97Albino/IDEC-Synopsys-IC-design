...
#define SAED32_28_PDK "/home/KNUEEhdd1/elec413/saed28nm/customPDK32nm"
...
nmos_list:dev_names = {"n105","n25","n18","n105_lvt","n105_hvt"};

pmos_list:dev_names = {"p105","p25","p18","p105_lvt","p105_hvt"};
...
lpp_layer    = {lpp_polygon_layer   = "CO",
                   lpp_polygon_purpose = "drawing",
                   lpp_port_layer      = "COnotmapped",
                   lpp_port_purpose    = "net",
                   lpp_subnode_layer   = "COnotmapped",
                   lpp_subnode_purpose = "subnode"}
);//AREA=0.144 RPV=0
